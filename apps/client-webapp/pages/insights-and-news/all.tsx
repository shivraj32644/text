...
import { useGetInsights } from '@corpcare/shared/api';
import {
  DashboardHead,
...
export default function AllInsightsPage() {
  const { data, isLoading, isError } = useGetInsights(undefined, 999);
  ...
  return (
    <div className="xl:overflow-hidden h-full flex flex-col">
      <DashboardHead>
        <h2 className="font-medium">All Insights</h2>
...
AllInsightsPage.getLayout = function getLayout(page: ReactElement) {
