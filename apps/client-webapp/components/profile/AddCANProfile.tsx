...
export function AddCANProfile({ isOpen, setIsOpen }) {
              ...
              >
                <Dialog.Panel className="w-full max-w-[500px] transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                  ...
                  <section className="flex justify-center items-center gap-6 p-10">
                    {/* <section
                      onClick={() => router.push('/profile/can-validation')}
                      className="flex flex-col p-6 items-center border-[1px] border-brandLight bg-lighter gap-4 w-full max-w-[200px] hover:cursor-pointer"
                    >
                      <img src="/valid-resume.png" alt="validate_can" />
                    ...
                    >
                      <img src="/edit-resume.png" alt="apply_for_new_can" />
                      <p className="text-sm text-black font-normal hover:cursor-pointer">
                        Apply for New eCAN
                      </p>
                    </section>
