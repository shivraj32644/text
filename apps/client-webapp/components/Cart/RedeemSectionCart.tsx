...
export const RedeemSectionCart = ({
  data,
  isLoading,
  can_number,
}: {
      ...
      {data && Object.keys(data).length !== 0 ? (
        <>
          ...
          <div className="Card overflow-hidden p-0 flex flex-col bg-white">
            ...
            <div className="mt-auto bg-lighter grid-cols-2 p-5 lg:p-8 border-t gap-6 text-sm  hidden lg:grid">
              <button
                className="OutlineButton py-4 uppercase"
                onClick={() =>
                  router.push({
                    pathname: '/mutual-funds/cart/transaction',
                    query: {
                      cart_id: data.id,
                      transaction_type: CART_TYPE.REDEMPTION,
                    },
                  })
                }
              >
          ...
          <div className="mt-auto grid grid-cols-2 gap-6 text-sm lg:hidden mb-12">
            <button
              className="OutlineButton py-4 uppercase"
              onClick={() =>
                router.push({
