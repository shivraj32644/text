...
export function TheProcessWeFollow({ data }: { data: ITheWayItWorks }) {
    ...
    >
      ...
      <div className="container mx-auto p-5 lg:p-10">
        ...
        <div className="hidden lg:block relative">
          ...
          <section className="flex justify-between absolute w-full bottom-[0.125em] z-10">
            <div
            ...
            {data?.items?.map((item, index) => {
              ...
              return (
                <div key={index} className=" flex w-full justify-around gap-10">
                  ...
                  <div className="lg:max-w-[240px] w-full h-[15rem] bg-white p-5 border border-brand rounded-md my-3 overflow-y-auto">
                    <img
                      src={cardImage?.url}
                      alt={cardImage?.alternativeText}
                    ...
                    <p className="text-md">{item.cardDescription}</p>
                  </div>
                </div>
              );
            })}
